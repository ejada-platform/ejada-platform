...
<div className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Add, edit, and deactivate users.</p>
                    </Link>
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Set up new classes and assign teachers.</p>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-xl font-semibold text-gray-900 dark:text-white">Curriculum Builder</span>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Design and structure the syllabus.</p>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-xl font-semibold text-gray-900 dark:text-white">Review Applications</span>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Process new student enrollments.</p>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-xl font-semibold text-gray-900 dark:text-white">Teacher Attendance</span>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Monitor teacher attendance records.</p>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-xl font-semibold text-gray-900 dark:text-white">{t('teacher_payroll')}</span>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage and process teacher salaries.</p>
                    </Link>
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Upload and categorize digital assets.</p>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-xl font-semibold text-gray-900 dark:text-white">Manage Templates</span>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Edit and manage system-wide templates.</p>
                    </Link>
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Create and assign achievement badges.</p>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-xl font-semibold text-gray-900 dark:text-white">Academic Calendar</span>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">View and manage the academic year schedule.</p>
                    </Link>
